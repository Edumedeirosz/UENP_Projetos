//Definindo os pinos de controle do motor
...
//Definindo os pinos dos sensores, baseando-se na placa do arduíno.
#define pin_S1 41
#define pin_S2 43
bool Sensor1 = 0;
bool Sensor2 = 0;

//Variável que a velocidade dos motores, podendo ser alterada de acordo com sua vontade.
int velocidade = 150;
...
void loop() {
  ...
  else if ((Sensor1 == 0) && (Sensor1 == 0)) { // Os dois motoresdetectam preto (opcional: parar, depende da escolha de lógica preferida), neste caso, passam direto.
    analogWrite(M1, velocidade);
    analogWrite(M2, velocidade);
  }
}
